...
use SimpleSAML\WebServices\Addressing\XML\wsam\InterfaceName;
...
/**
 * Class \SimpleSAML\WebServices\Addressing\XML\wsam\InterfaceNameTest
 *
...
final class InterfaceNameTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/wsam/InterfaceName.xml',
        );
    }
    ...
    public function testMarshalling(): void
    {
        ...
        $actualXml = strval($interfaceName);
