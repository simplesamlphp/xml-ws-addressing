...
use SimpleSAML\WebServices\Addressing\XML\wsaw\ServiceName;
...
/**
 * Class \SimpleSAML\WebServices\Addressing\XML\wsaw\ServiceNameTest
 *
...
final class ServiceNameTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/wsaw/ServiceName.xml',
        );
    }
