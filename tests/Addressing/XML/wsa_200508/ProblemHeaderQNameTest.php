...
use SimpleSAML\WebServices\Addressing\XML\wsa_200508\AbstractAttributedQNameType;
use SimpleSAML\WebServices\Addressing\XML\wsa_200508\AbstractWsaElement;
use SimpleSAML\WebServices\Addressing\XML\wsa_200508\ProblemHeaderQName;
...
final class ProblemHeaderQNameTest extends TestCase
{
    ...
    public function testMarshalling(): void
    {
        ...
        $actualXml = strval($problemHeaderQName);
