...
use SimpleSAML\WebServices\Addressing\XML\wsa_200508\AbstractProblemActionType;
...
use SimpleSAML\WebServices\Addressing\XML\wsa_200508\ProblemAction;
...
final class ProblemActionTest extends TestCase
{
    ...
    public function testMarshalling(): void
    {
        ...
        $actualXml = strval($problemAction);
